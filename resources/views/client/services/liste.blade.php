                            ...
                            <tbody>
                             ...
                             @foreach ($service as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="{{ route('client.abonnement.show',['abonnement'=>$item->id])}}" title="Details" class="btn btn-light btn-sm text-info">
                                            <i class="mdi mdi-account-card-details font-18"></i>
                                    </a>
                                    </td>
                                    <td>
                                        <a href="{{route('client.facture.show',['facture'=>$item->id])}}" title="Facture">
