...
<div class="card">
    <div class="card-body">
        ...
        <div class="p-3">
            ...
            <p class="text-muted text-center">Connectez-vous pour accéder à l'application</p>
            @if (session('error'))
            ...
            <form class="form-horizontal m-t-30" method="POST" action="/admin/login">
                ...
                <div class="form-group m-t-10 mb-0 row">
                    <div class="col-12 m-t-20">
                        <a href="{{ route('admin.forgot-password') }}" class="text-muted"><i class="mdi mdi-lock"></i> Mot de passe oublié?</a>
                    </div>
                </div>
            </form>
        </div>
