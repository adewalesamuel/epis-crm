...
!function ($) {
    ...
    MainApp.prototype.initMenu = function () {
        ...
        MainApp.prototype.Parsley = function () {
            $(document).ready(function() {
                $('form').parsley();
            });
        },
        MainApp.prototype.confirmDeletion = function () {
            let forms = Array.from(document.querySelectorAll('table form'));
            ...
            for (let form of forms) {
              form.addEventListener('submit', (event) => {
                event.preventDefault();
                let conf = confirm('Voulez vous vraiment supprimer cet element ?');
                if (conf) {
                    event.target.submit();
                }
              })
