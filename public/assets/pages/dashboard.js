...
!function ($) {
    ...
    var Dashboard = function () {
        ...
        this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b', 'c'], ['Certificats', 'Hebergement', 'Domaines'], ['#ccc', '#ffa726', '#4bbbce']);

            //creating donut chart
            var $donutData = [
                {label: "Certificats", value: 12},
                {label: "Domaines", value: 42},
                {label: "HHebergement", value: 20}
            ];
