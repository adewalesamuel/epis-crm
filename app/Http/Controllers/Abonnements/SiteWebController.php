...
use Exception;
use App\Http\Requests\StoreAbonnementSiteWeb;
use App\Http\Requests\UpdateAbonnementSiteWeb;

class SiteWebController extends Controller
{
    const SERVICE = 'siteweb';
    /**
    ...
    public function index(Request $request)
    {
        try {
            ...
            $data = [
                'title' => 'Liste des abonnements de site web',
                'sitewebs' => $abonnements,
            ];

            return view('admin.abonnements.siteweb.index', $data);
        } catch (Exception $e) {
    ...
    public function create($id)
    {
        ...
        $sitewebs = Service::where('designation', self::SERVICE)->get();
        $data = [
            'title' => 'Créer un abonnement de site web',
            'client' => $client,
            'sitewebs' => $sitewebs
        ];

        return view('admin.abonnements.siteweb.create', $data);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreAbonnementSiteWeb $request)
    {
    ...
    public function show($id)
    {
        ...
        $data = [
            'title' => 'Details du site web',
            'siteweb' => $abonnement
        ];

        return view('admin.abonnements.siteweb.show', $data); //return view
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.abonnements.siteweb.edit', $data);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateAbonnementSiteWeb $request, $id)
    {
        $data = $request->validated();
