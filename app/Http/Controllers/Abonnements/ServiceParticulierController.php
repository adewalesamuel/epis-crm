...
use Exception;
use App\Http\Requests\StoreAbonnementServiceParticulier;
use App\Http\Requests\UpdateAbonnementServiceParticulier;

class ServiceParticulierController extends Controller
{
    const SERVICE = 'service_particulier';
    /**
    ...
    public function index(Request $request)
    {
        try {
            ...
            $data = [
                'title' => 'Liste des abonnements des autres services',
                'services_particuliers' => $abonnements,
            ];

            return view('admin.abonnements.service_particulier.index', $data);
        } catch (Exception $e) {
    ...
    public function create($id)
    {
        ...
        $data = [
            'title' => 'Créer un abonnement des autres services',
            'client' => $client,
            'services_particuliers' => $certificatsssl
        ];

        return view('admin.abonnements.service_particulier.create', $data);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreAbonnementServiceParticulier $request)
    {
    ...
    public function show($id)
    {
        ...
        return view('admin.abonnements.service_particulier.show', $data); //return view
    }
    ...
    public function edit($id)
    {
        ...
        $data = [
            ...
            'service_particulier' => $abonnement,
            'services_particuliers' => $certificatsssl,
            'client' => $client
        ];

        return view('admin.abonnements.service_particulier.edit', $data);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateAbonnementServiceParticulier $request, $id)
    {
        $data = $request->validated();
